                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="file" type="file" class="form-control @error('file') is-invalid @enderror" name="file" onchange="previewImage(event)">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 offset-md-4">
                                    <img id="preview" src="" alt="Previsualización de imagen" class="img-thumbnail" style="display:none; width: 150px; height: 150px;">
                                </div>
                            </div>
